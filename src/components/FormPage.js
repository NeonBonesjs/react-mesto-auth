  ...
  return(
    <>
      <form className="form-sing" onSubmit={props.onSubmit}>
        ...
        <input className="form-sing__input" placeholder="Пароль" value={props.inputValue2} onChange={props.inputOnChange2} minLength="6" maxLength="13" type='password' id='form-sing-input2'>
        </input>
